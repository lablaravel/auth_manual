            ...
            <form class="max-w-sm m-4 p-10 bg-white bg-opacity-25 rounded shadow-xl">
                <p class="text-white font-medium text-center text-lg font-bold">LOGIN</p>
                  <div class="">
                    ...
                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white" type="text" id="cpf"  placeholder="Digite o cpf" aria-label="cpf" required>
                  </div>
                  <div class="mt-2">
                    <label class="block  text-sm text-white">Telefone</label>
                     <input class="w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white"
                      type="tel" id="cellphone" placeholder="Digite o seu telefone" arial-label="cellphone" required>
                  </div>
